...
-(void)presentCamera
{
    ...
    [self.cameraButton setBackgroundImage:[UIImage imageNamed:@"camera2"] forState:UIControlStateNormal];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    self.pickedPhoto.likesCounter = @0;
...
//            [self.pickedPhoto saveInBackground];
//        }];
        self.pickedPhoto.imageDescription = self.commentTextView.text;
        [self.pickedPhoto saveInBackground];
